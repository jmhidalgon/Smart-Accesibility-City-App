package sacapp.android.jmhidalgo.smartaccesibilitycityapp.accessdb.locationservice;
...
public class NotifyNearlyService extends Service
{
    ...
    private class LocationListener implements android.location.LocationListener
    {
        ...
        public void onLocationChanged(Location location)
        {
            ...
            for(int i=0; i<NotifyNearlyService.getEntities().size(); ++i){
                Entity entity = NotifyNearlyService.getEntities().get(i);
    ...
    public static void setEntities(ArrayList<Entity> entities) {
        NotifyNearlyService.entities = entities;
    }
